...
Many QKD protocols exist \cite{aliro2025bbm92, sujay2023bb84, fujiwara2015e91} that enable the generation of secure keys by exploiting the principles of quantum mechanics. This thesis focuses on implementing the E91 key distribution protocol due to its use of entangled qubits and Bell-state verification.
