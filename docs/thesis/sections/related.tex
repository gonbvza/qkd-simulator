...
However, QKDNetSim differs in that it does not model quantum physical behavior. Instead, it simulates only the packet-based communication required for QKD between nodes. For this reason, QKDNetSim is built on top of \textbf{ns-3}, a discrete-event, classical network simulator.
